...
import com.dm.springcloud.util.ErrorEnum;
import com.dm.springcloud.util.ErrorResult;
...
public class MyUrlBlockHandler implements UrlBlockHandler {
    ...
    public static final Logger log = LoggerFactory.getLogger(MyUrlBlockHandler.class);
